...
const Footer = () => {
  return (
    <footer className="footer items-center p-4 mt-10 text-black bg-cyan-400 px-16">
      <aside className="items-center grid-flow-col">
        <BiTask className="text-5xl text-black" />
    ...
    //         <footer className="footer justify-center py-10 mt-10 bg-cyan-400 text-black px-16">
    ...
    //     <p className='text-xl font-medium'>Task manager</p>
    //     <p>Providing reliable service since 2020</p>
